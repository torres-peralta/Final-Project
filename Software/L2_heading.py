...
import numpy as np                                  # library for math operations                                   # library for time access
import time

xRange = np.array([-68, 72])                         # range must be updated for your device
yRange = np.array([-65, 63])                        # range must be updated for your device
